...
const PersonSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isClient': PropertySchema(id: 1, name: r'isClient', type: IsarType.bool),
...
void _personSerialize(
  ...
  writer.writeBool(offsets[1], object.isClient);
...
Person _personDeserialize(
  ...
  object.id = id;
  object.isClient = reader.readBool(offsets[1]);
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> isClientEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'isClient', value: value),
      );
    });
  }
...
extension PersonQuerySortBy on QueryBuilder<Person, Person, QSortBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByIsClient() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isClient', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByIsClientDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isClient', Sort.desc);
    });
  }
...
extension PersonQuerySortThenBy on QueryBuilder<Person, Person, QSortThenBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByIsClient() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isClient', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByIsClientDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isClient', Sort.desc);
    });
  }
...
extension PersonQueryWhereDistinct on QueryBuilder<Person, Person, QDistinct> {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByIsClient() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isClient');
    });
  }
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, bool, QQueryOperations> isClientProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isClient');
    });
  }
