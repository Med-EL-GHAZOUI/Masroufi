...
extension TransactionCategoryByIndex on IsarCollection<TransactionCategory> {
  Future<TransactionCategory?> getByFirestoreId(String firestoreId) {
    return getByIndex(r'firestoreId', [firestoreId]);
  }

  TransactionCategory? getByFirestoreIdSync(String firestoreId) {
  ...
  Future<List<TransactionCategory?>> getAllByFirestoreId(
  ...
  List<TransactionCategory?> getAllByFirestoreIdSync(
    List<String> firestoreIdValues,
  ) {
    final values = firestoreIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByFirestoreId(TransactionCategory object) {
    return putByIndex(r'firestoreId', object);
  }

  Id putByFirestoreIdSync(TransactionCategory object, {bool saveLinks = true}) {
    return putByIndexSync(r'firestoreId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByFirestoreId(List<TransactionCategory> objects) {
    return putAllByIndex(r'firestoreId', objects);
  }

  List<Id> putAllByFirestoreIdSync(
    List<TransactionCategory> objects, {
    bool saveLinks = true,
  }) {
...
extension TransactionCategoryQueryFilter
    on
        QueryBuilder<
          TransactionCategory,
          TransactionCategory,
...
extension TransactionCategoryQueryObject
    on
        QueryBuilder<
          TransactionCategory,
          TransactionCategory,
...
extension TransactionCategoryQueryLinks
    on
        QueryBuilder<
          TransactionCategory,
          TransactionCategory,
...
extension TransactionCategoryQueryProperty
  ...
  QueryBuilder<TransactionCategory, bool, QQueryOperations>
  isExpenseProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionCategory, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
